...
CBulletRockman::CBulletRockman(D3DXVECTOR2 v, D3DXVECTOR2 beginPosition, int typeID, CSprite sprite, int dame) :CBullet(0, ID_BULLET_ROCKMAN_NORMAL, sprite, dame, v, beginPosition)
{
...
void CBulletRockman::Render(CTimer* gameTime, MGraphic* graphics)
{
...
void CBulletRockman::Update(CTimer* gameTime)
{
