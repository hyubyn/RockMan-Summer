...
CSprite::CSprite(char* pNamePath, int countRow, int countColumn, int countFrame, int timeFrame, D3DCOLOR color,  LPDIRECT3DDEVICE9 device) : CTexture(pNamePath, color, device)
{
