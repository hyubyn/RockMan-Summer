...
public:
	...
	CEnemyBoomBullet(int id, int typeID, CSprite spriteBullet, CSprite spriteExplodingEffect, int dame, D3DXVECTOR2 beginPosition, float lMaxJump, float angleJump);
