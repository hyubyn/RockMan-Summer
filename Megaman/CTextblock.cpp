...
int CTextblock::Initlize(MGraphic* graphic)
{
...
void CTextblock::Render(CTimer* gameTime, Camera* cam, MGraphic* graphics)
{
	if (_isAnimation)
	{
		_tick += gameTime->GetTime();
		_tickAnimation += gameTime->GetTime();
...
void CTextblock::Update(CTimer* gameTime)
{
