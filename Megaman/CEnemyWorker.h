...
{
public:
	CEnemyWorker(int id, int typeID, CSprite sprite, CSprite spriteExplodingEffect, float vX, D3DXVECTOR2 positionBegin, int dame, int blood = 30, int score=SCORE_DEFAULT);
	~CEnemyWorker();
