...
void CEnemyNinja::Update(CTimer* gameTime, Megaman* rockman)
{
	...
	case STATICNINJA::NINJAFIRE:
		...
		if (_timeFire <= 0)
		{
			...
			{
				_lstBullet.clear();
				_lstBullet.push_back(new CBulletNinja(0, ID_BULLET_ENEMY_NINJA, ResourceManager::GetSprite(ID_SPRITE_BULLET_ENEMY_NINJA), DAME_BULLET_NINJA, 0, D3DXVECTOR2(0, 0), 0, _position.x, _position.y));
...
void CEnemyNinja::Update(CTimer* gameTime)
{

}
void CEnemyNinja::Jump(D3DXVECTOR2 positionRockman,TYPEJUMP typeJump)
{
...
void CEnemyNinja::Render(CTimer* gameTime, MGraphic* graphics)
{
