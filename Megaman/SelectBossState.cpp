...
CSelectBossState::CSelectBossState(MGraphic* graphic, LPDIRECT3DDEVICE9 d3ddev): CScreen()
{
	...
	_title._position = D3DXVECTOR2(0, SCREEN_HEIGHT -50);
	...
	_title._color  = D3DCOLOR_XRGB(252, 252, 252);;
	...
	_boss[2]._position = D3DXVECTOR2(SCREEN_WIDTH / 2 + 44, SCREEN_HEIGHT / 2 + 67);
	...
	_boss[5]._position = D3DXVECTOR2(SCREEN_WIDTH / 2 - 90, SCREEN_HEIGHT / 2 + 67);
