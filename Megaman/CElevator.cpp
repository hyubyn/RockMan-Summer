...
CElevator::CElevator(int id, int typeID, CSprite sprite, float vX, D3DXVECTOR2 positionBegin) :CMoveableObject()
{
	_id = id;
	_typeID = typeID;
	_sprite = sprite;
...
void CElevator::Update(CTimer* gameTime)
{
...
void CElevator::Render(CTimer* gameTime, MGraphic* graphics)
{
