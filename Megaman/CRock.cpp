...
void CRock::Render(CTimer* gameTime, MGraphic* graphics)
{
	RECT rectBorder;
	...
	graphics->Draw(_texture.GetTexture(), rectBorder, false, D3DXVECTOR2(_box._width / _texture.GetWidth(), _box._height / _texture.GetHeight()));

	CStaticObject::Render(gameTime, graphics);
}

void CRock::Update(CTimer* gameTime)
{
