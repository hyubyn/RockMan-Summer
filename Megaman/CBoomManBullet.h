...
{
public:
	CBoomManBullet(int id, int typeID, CSprite sprite, int dame, D3DXVECTOR2 v, D3DXVECTOR2 beginPosition);
	~CBoomManBullet();
	...
	D3DXVECTOR2 _posRockManStand; // Vị trí của rock man khi nó đứng ban đầu
	D3DXVECTOR2 _posRockMan; // Vị trí của rock man khi nó đứng
	D3DXVECTOR2 _posBoomMan; // Vị trí của BoomMan khi nó đứng
