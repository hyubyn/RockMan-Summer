...
{
public:
	CGutsManBullet(int id, int typeID, CSprite sprite, int dame, D3DXVECTOR2 v, D3DXVECTOR2 beginPosition);
	~CGutsManBullet();
	...
	D3DXVECTOR2 _posGutsMan; // Vị trí của BoomMan khi nó đứng
	D3DXVECTOR2 _posBurst; //Vị trí bắt đầu mặc định của quả boom.
