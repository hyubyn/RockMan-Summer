...
CEnemyWallShooter::CEnemyWallShooter(int id, int typeID, CSprite sprite, CSprite spriteExplodingEffect, ENEMYWALLSHOOTER_ORIENTATION orientation, D3DXVECTOR2 v, D3DXVECTOR2 positionBegin, int dame, int blood, int score) :CEnemy()
{
	_id = id;
	_typeID = typeID;
	_sprite = sprite;
...
void CEnemyWallShooter::Render(CTimer* gameTime, MGraphic* graphics)
{
	if (_orientation == ENEMYWALLSHOOTER_ORIENTATION::LEFT)
