...
// File: Megaman.h
//
// Desc: Định nghĩa lớp Megaman có các dạng như Score, Mana, Power
//
//-----------------------------------------------------------------------------
...
#define ROCKMAN_VERLOCITY_Y		355.0f/1100.0f
#define ROCKMAN_ACCELERATE_X	0.00075f/1000.0f
#define ROCKMAN_ACCELERATE_Y	1.09f/1100.0f

class CPlayScreen;

class Megaman :public CMoveableObject
{
public:
	Megaman();
	~Megaman();
